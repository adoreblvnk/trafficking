...
/**
 * Platform-independent IO provider interface.
 * Abstracts reading and writing text files from assets and local storage.
 */
public interface IIOProvider {
     ...
     *
     * @param internalPath internal resource path
