...
public final class TrashFactory {
    ...
    public static TrashEntity createTrash(TrashType type, float x, float y, PinballEventBus eventBus) {
        ...
        return switch (type) {
            case PLASTIC ->
                new TrashEntity(id, x, y, com.sit.recyclingpinball.logic.LogicConstants.TEX_TRASH_PLASTIC, eventBus);
            case PAPER ->
                new TrashEntity(id, x, y, com.sit.recyclingpinball.logic.LogicConstants.TEX_TRASH_PAPER, eventBus);
            case GLASS ->
                new TrashEntity(id, x, y, com.sit.recyclingpinball.logic.LogicConstants.TEX_TRASH_GLASS, eventBus);
        };
    }
}
