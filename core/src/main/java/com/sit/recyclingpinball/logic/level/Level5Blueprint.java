...
public class Level5Blueprint extends BaseLevelBlueprint {
    ...
    protected void addCustomElements(BoardBuilder builder) {
        ...
        // Trash Layout
        // Tier 1 Trash
        builder.addTrash(TrashType.PLASTIC, 950, 850).addTrash(TrashType.PAPER, 1075, 850).addTrash(TrashType.GLASS,
                1200, 850);

        // Tier 2 Trash
        builder.addTrash(TrashType.GLASS, 900, 550).addTrash(TrashType.PLASTIC, 1075, 550).addTrash(TrashType.PAPER,
                1250, 550);

        // Tier 3 Trash
        builder.addTrash(TrashType.PAPER, 950, 250).addTrash(TrashType.GLASS, 1075, 250).addTrash(TrashType.PLASTIC,
                1200, 250);
    }
