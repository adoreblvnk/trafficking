...
public class PlatformRectangle {
    ...
    public static boolean intersectRectangles(PlatformRectangle rectangle1, PlatformRectangle rectangle2,
            PlatformRectangle intersection) {
        return com.badlogic.gdx.math.Intersector.intersectRectangles(rectangle1.getDelegate(), rectangle2.getDelegate(),
                intersection.getDelegate());
    }
