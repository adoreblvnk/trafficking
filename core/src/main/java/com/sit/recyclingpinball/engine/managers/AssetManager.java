...
/**
 * Centralized manager for loading and tracking game assets.
 * Ensures assets are loaded once at startup.
 */
public class AssetManager {
     ...
     *
     * @param provider the audio provider used to load sounds
     */
